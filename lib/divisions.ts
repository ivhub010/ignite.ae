...
export const DIVISIONS: Division[] = [
  ...
  { num:'05', label:'Fitness & Wellness', color:'#C2D500', href:'https://ignite-wellness.com/ ',  external:true,   chips:['Boot Camp','Yoga','Classes'],         image:'/assets/images/lifestyle-4A0A2745.jpg' },
