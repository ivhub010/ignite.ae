...
export default function SiteFooter() {
  return (
    <>
      <footer className="site-footer">
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <a href="tel:800446483" className="footer-contact-link">800 IGNITE</a>
            <a href="mailto:info@ignite.ae" style={{ color: 'rgba(255,255,255,.5)', fontSize: 13, display: 'block', marginTop: 8 }}>info@ignite.ae</a>
            <a href="https://wa.me/971" style={{ color: '#25D366', fontSize: 13, fontWeight: 600, display: 'block', marginTop: 10 }}>WhatsApp →</a>
          </div>
        </div>
      ...
      <a href="https://wa.me/971" className="whatsapp-fab" aria-label="Chat on WhatsApp">
